generate_construct_overview <- function(dctSpec,
  ...
  res <-
    c("",
      paste0(ufs::repStr("#", headingLevel), " ", dctSpec$id),
      "",
      ...
      "",
      paste0(ufs::repStr("#", headingLevel+1), " Instruction for developing a measurement instrument"),
      "",
      ...
      "",
      paste0(ufs::repStr("#", headingLevel+1), " Instruction for developing a manipulation"),
      "",
